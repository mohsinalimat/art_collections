...
def get_data(filters):
	...
	slideshow.allow_insufficient_images_for_web_art,
	IF(slideshow.allow_insufficient_images_for_web_art = 1,
	 concat("<input type='checkbox' id=", slideshow.name, " onclick='toggle_allow_insufficient_images(&quot;", slideshow.name, "&quot;);' class='buzz' checked/>") , 
	 concat("<input type='checkbox' id=", slideshow.name, " onclick='toggle_allow_insufficient_images(&quot;", slideshow.name, "&quot;);' class='buzz' />")) check_allow_insuf,
...
left outer join 
 (
	SELECT
		...
		SUM(slideshow_item.heading REGEXP '^fr') fr_count,
		SUM(slideshow_item.heading REGEXP '^ba') ba_count
	FROM
